...
A PersistentFleet Pod can stay `Running` after its celld child exits; the
launcher keeps the child stopped and readiness fails. See [runtime recovery](../../troubleshoot/recovery/)
