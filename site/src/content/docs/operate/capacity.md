...
Pause workload changes with `spec.maintenance.paused: true`. Removing the policy returns toward the manual replica target and can request a blocked reduction. Check the resulting target and [scaling procedure](../scaling/) first.
