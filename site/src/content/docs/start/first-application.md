...
This confirms an application request through your fleet. For failure and recovery behavior, use the [operational procedures](../../troubleshoot/recovery/) and [test records](../../qualification/).
