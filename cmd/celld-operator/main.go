...
func run() error {
	...
	reconciler := &controller.Reconciler{Collector: collector, Client: direct, Options: controller.Options{OperatorNamespace: *namespace, LocalTest: *localTest, LauncherImage: *launcherImage, FaultPoint: *faultPoint, LocalRWOP: *localRWOP, FencingAccount: *fencingAccount, FencingRegion: *fencingRegion}, NetworkPolicyEnforced: *enforced}
	if *fencingAccount != "" {
