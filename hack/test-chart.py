...
assert {doc['spec']['names']['kind'] for doc in base if doc['kind'] == 'CustomResourceDefinition'} == {'CelldFleet', 'CelldPreview', 'CelldPreviewPool', 'CelldPreviewSeed', 'CelldStorageReservation'}
