...
func TestSharedStorageValidation(t *testing.T) {
	...
	for name, mutate := range map[string]func(*StorageSpec){
		...
		"empty pool identity":           func(s *StorageSpec) { s.PoolRef.UID = "" },
